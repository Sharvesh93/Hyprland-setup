...
hl.bind(mainMod .. "+O", hl.dsp.exec_cmd(ipc .. "panel-toggle control-center"))
...
--hl.bind(
--	mainMod .. " + SPACE",
--	hl.dsp.exec_cmd('qs -p /home/sharvesh/.config/quickshell/ukishima ipc call ukishima launcher ""')
--) -- App Launcher
--hl.bind(mainMod .. " + U",hl.dsp.exec.cmd("hyprctl keyword monitor eDP-1 , preferred , auto , 1"))
hl.bind(mainMod .. " + U", hl.dsp.exec_cmd("hyprctl keyword monitor HDMI-A-1,preferred,auto,1,mirror,eDP-1"))
-- =========================================================================
-- UTILITIES & SCRIPTS
-- =========================================================================
...
hl.bind(
	mainMod .. " + W",
	hl.dsp.exec_cmd('qs -p /home/sharvesh/.config/quickshell/ukishima ipc call ukishima wallpaper ""')
) -- QS Wallpaper
hl.bind(
	mainMod .. " + V",
	hl.dsp.exec_cmd('qs -p /home/sharvesh/.config/quickshell/ukishima ipc call ukishima clipboard ""')
) -- QS Clipboard
hl.bind(mainMod .. " + Tab", hl.dsp.exec_cmd("~/.local/bin/wallpaper.sh random")) -- Random Wallpaper
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("~/.local/bin/cpu-mode.sh"))

-- Screenshots
hl.bind(
	mainMod .. " + Print",
	hl.dsp.exec_cmd("mkdir -p ~/Pictures/Screenshots && grim ~/Pictures/Screenshots/$(date +%Y-%m-%d).png")
)
hl.bind(
	mainMod .. " + S",
	hl.dsp.exec_cmd(
		'mkdir -p ~/Pictures/Screenshots && FILE=~/Pictures/Screenshots/$(date "+%Y-%m-%d_%H-%M-%S").png && grim -g "$(slurp -d)" "$FILE" && wl-copy < "$FILE"'
	)
)
